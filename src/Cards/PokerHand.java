...
public class PokerHand extends Hand {
	...
	private boolean hasJacksOrBetter() {
		for (int i = 0; i < size() - 1; i++) {
			if (get(i).getValue() == get(i + 1).getValue() &&
					(get(i).getValue() == 1 || get(i).getValue() > 10)) {
				return true;
			}
		}
		return false;
	...
	private boolean hasStraight() {
		...
		if (get(0).getValue() == 1 && get(1).getValue() == 10 && get(2).getValue() == 11 && get(3).getValue() == 12
				&& get(4).getValue() == 13) {
			return true;
		}
	...
	private boolean hasFullHouse() {
		if (get(0).getValue() == get(1).getValue() && get(2).getValue() == get(4).getValue()
				|| get(0).getValue() == get(2).getValue() && get(3).getValue() == get(4).getValue())
			return true;
		return false;
	}
	...
	private boolean hasThreeOfAKind() {
		if (get(0).getValue() == get(2).getValue() || get(1).getValue() == get(3).getValue()
	...
	private boolean hasPair() {
		if (get(0).getValue() == get(1).getValue() || get(1).getValue() == get(2).getValue()
				|| get(2).getValue() == get(3).getValue() || get(3).getValue() == get(4).getValue())
			return true;
		return false;
	}
	...
	public HandTypes getHandType() {
		...
		if (get(0).getValue() == 1 && get(4).getValue() == 13 && hasFlush() && hasStraight()) {
